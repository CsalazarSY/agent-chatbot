...
class UseTypeEnum(str, Enum):
    ...
    BUSINESS = "Business"
    @classmethod
    def get_all_values(cls) -> List[str]: return [e.value for e in cls]
...
custom_quote_form_fields = [
  ...
  },
  {
    ...
    "condition": {
      "field": "use_type",
      "value": UseTypeEnum.BUSINESS.value
    }
  },
  {
  ...
  },
  {
    ...
    "condition": {
      "field": "product_group",
      "value": ProductGroupEnum.CLING.value
    }
  },
  {
    ...
    "condition": {
      "field": "product_group",
      "value": ProductGroupEnum.DECAL.value
    }
  },
  {
    ...
    "condition": {
      "field": "product_group",
      "value": ProductGroupEnum.MAGNET.value
    }
  },
  {
    ...
    "condition": {
      "field": "product_group",
      "value": ProductGroupEnum.PATCH.value
    }
  },
  {
  ...
  },
  {
    ...
    "condition": {
      "field": "product_group",
      "value": ProductGroupEnum.TATTOO.value
    }
  },
  {
    ...
    "condition": {
      "field": "product_group",
      "value": ProductGroupEnum.TAPE.value
    }
  },
  {
    ...
    "condition": {
      "field": "product_group",
      "any_of_values": [ProductGroupEnum.STICKER.value, ProductGroupEnum.ROLL_LABEL.value]
    }
  },
  {
