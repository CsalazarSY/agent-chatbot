...
class DeliveryIdentifier(BaseModel):
    ...
    type: Optional[str] = Field(
        None, description="The type of the delivery identifier (e.g., 'EMAIL')."
    )
    value: Optional[str] = Field(
        None,
        description="The value of the delivery identifier (e.g., 'test@example.com').",
    )
...
class PagingNext(BaseModel):
    ...
    after: Optional[str] = Field(
        None, description="The cursor token to use for the next page request."
    )
...
class Paging(BaseModel):
    ...
    next: Optional[PagingNext] = Field(
        None, description="Details for accessing the next page, if available."
    )
...
class MessageStatusFailureDetails(BaseModel):
    ...
    errorMessageTokens: Optional[Dict[str, str]] = Field(
        None, description="Tokens for constructing a localized error message."
    )
...
class MessageStatus(BaseModel):
    ...
    statusType: Optional[MessageStatusType] = Field(
        None, description="The high-level status (SENT, RECEIVED, FAILED)."
    )
    failureDetails: Optional[MessageStatusFailureDetails] = Field(
        None, description="Details if the statusType is FAILED."
    )
...
class ClientInfo(BaseModel):
    ...
    clientType: Optional[ClientType] = Field(
        None, description="The type of client (e.g., HUBSPOT, INTEGRATION)."
    )
    integrationAppId: Optional[int] = Field(
        None, description="The App ID if the clientType is INTEGRATION."
    )
...
class MessageSender(BaseModel):
    ...
    actorId: Optional[str] = Field(
        None,
        description="The HubSpot actor ID (e.g., 'A-xxxxx', 'U-xxxxx') of the sender.",
    )
    name: Optional[str] = Field(None, description="The display name of the sender.")
    senderField: Optional[str] = Field(
        None, description="Indicates the role of the sender (e.g., 'FROM')."
    )
    deliveryIdentifier: Optional[DeliveryIdentifier] = Field(
        None, description="The delivery identifier associated with the sender."
    )
...
class MessageRecipient(BaseModel):
    ...
    actorId: Optional[str] = Field(
        None,
        description="The HubSpot actor ID (e.g., 'A-xxxxx', 'V-xxxxx') of the recipient.",
    )
    name: Optional[str] = Field(None, description="The display name of the recipient.")
    deliveryIdentifier: Optional[DeliveryIdentifier] = Field(
        None, description="The delivery identifier for the recipient (can be null)."
    )
    recipientField: Optional[str] = Field(
        None, description="The role of the recipient (e.g., 'TO', 'CC', 'BCC')."
    )
...
class ThreadAssociations(BaseModel):
    ...
    associatedTicketId: Optional[str] = Field(
        None,
        alias="associatedTicketId",
        description="The ID of the associated HubSpot ticket, if any.",
    )
...
class Actor(BaseModel):
    ...
    type: Optional[ActorType] = Field(
        None, description="The type of the actor (e.g., AGENT, BOT)."
    )
    ...
    email: Optional[str] = Field(
        None,
        description="The email address associated with the actor (usually for AGENT type).",
    )
    avatar: Optional[str] = Field(
        None, description="A URL to the actor's avatar image."
    )
...
class ChannelAccount(BaseModel):
    ...
    createdAt: Optional[str] = Field(
        None, description="Timestamp when the channel account was created."
    )
    archivedAt: Optional[str] = Field(
        None, description="Timestamp when the channel account was archived."
    )
    archived: Optional[bool] = Field(
        None, description="Indicates if the channel account is archived."
    )
    authorized: Optional[bool] = Field(
        None,
        description="Indicates if HubSpot is authorized to use this channel account.",
    )
    name: Optional[str] = Field(None, description="The name of the channel account.")
    active: Optional[bool] = Field(
        None, description="Indicates if the channel account is currently active."
    )
    deliveryIdentifier: Optional[DeliveryIdentifier] = Field(
        None,
        description="The primary delivery identifier for this account (e.g., email address).",
    )
    id: str = Field(..., description="The unique ID of the channel account.")
    inboxId: Optional[str] = Field(
        None, description="The ID of the inbox this channel account belongs to."
    )
    channelId: Optional[str] = Field(
        None, description="The ID of the channel type (e.g., 'EMAIL', 'FB_MESSENGER')."
    )
...
class Channel(BaseModel):
    ...
    name: Optional[str] = Field(
        None, description="The name of the channel type (e.g., 'Email', 'Chat')."
    )
...
class Inbox(BaseModel):
    ...
    createdAt: Optional[str] = Field(
        None, description="Timestamp when the inbox was created."
    )
    archivedAt: Optional[str] = Field(
        None, description="Timestamp when the inbox was archived."
    )
    archived: Optional[bool] = Field(
        None, description="Indicates if the inbox is archived."
    )
    ...
    updatedAt: Optional[str] = Field(
        None, description="Timestamp when the inbox was last updated."
    )
...
class MessageType(str, Enum):
    ...
    THREAD_STATUS_CHANGE = (
        "THREAD_STATUS_CHANGE"  # Message indicating thread status change (Open/Closed)
    )
...
class MessageDetail(BaseModel):
    ...
    type: Optional[MessageType] = Field(
        None, description="The type of the message/event."
    )
    id: str = Field(..., description="The unique ID of the message.")
    conversationsThreadId: Optional[str] = Field(
        None,
        alias="conversationsThreadId",
    ...
    updatedAt: Optional[str] = Field(
        None, description="Timestamp when the message was last updated."
    )
    createdBy: Optional[str] = Field(
        None, description="Actor ID of the creator (might be system/integration)."
    )
    client: Optional[ClientInfo] = Field(
        None, description="Information about the client that created the message."
    )
    senders: Optional[List[MessageSender]] = Field(
        None, description="List of senders (usually one)."
    )
    recipients: Optional[List[MessageRecipient]] = Field(
        None, description="List of recipients."
    )
    archived: Optional[bool] = Field(
        None, description="Indicates if the message is archived."
    )
    ...
    subject: Optional[str] = Field(
        None, description="Subject line (primarily for email)."
    )
    truncationStatus: Optional[MessageTruncationStatus] = Field(
        None, description="Indicates if the message content is truncated."
    )
    inReplyToId: Optional[str] = Field(
        None, description="ID of the message this is a reply to (email threading)."
    )
    ...
    direction: Optional[MessageDirection] = Field(
        None, description="Direction of the message (INCOMING or OUTGOING)."
    )

    # --- Channel Fields ---
    channelId: Optional[str] = Field(None, description="ID of the channel type used.")
    channelAccountId: Optional[str] = Field(
        None, description="ID of the specific channel account used."
    )

    # --- Fields for specific types ---
    assignedTo: Optional[str] = Field(
        None, description="Actor ID assigned (for ASSIGNMENT type)."
    )
    newStatus: Optional[str] = Field(
        None, description="New thread status (for THREAD_STATUS_CHANGE type)."
    )
...
class ThreadDetail(BaseModel):
    ...
    associatedContactId: Optional[str] = Field(
        None,
        alias="associatedContactId",
        description="ID of the primary associated contact.",
    )
    threadAssociations: Optional[ThreadAssociations] = Field(
        None, description="Contains IDs of associated objects like tickets."
    )
    assignedTo: Optional[str] = Field(
        None, description="Actor ID of the HubSpot user assigned to the thread."
    )
    createdAt: Optional[str] = Field(
        None, description="Timestamp when the thread was created."
    )
    archived: Optional[bool] = Field(
        None, description="Indicates if the thread is archived."
    )
    originalChannelId: Optional[str] = Field(
        None, description="ID of the channel type where the thread originated."
    )
    latestMessageTimestamp: Optional[str] = Field(
        None, description="Timestamp of the latest message (sent or received)."
    )
    latestMessageSentTimestamp: Optional[str] = Field(
        None, description="Timestamp of the latest outgoing message."
    )
    originalChannelAccountId: Optional[str] = Field(
        None,
        description="ID of the specific channel account where the thread originated.",
    )
    id: str = Field(..., description="The unique ID of the thread.")
    closedAt: Optional[str] = Field(
        None, description="Timestamp when the thread was closed."
    )
    spam: Optional[bool] = Field(
        None, description="Indicates if the thread is marked as spam."
    )
    inboxId: Optional[str] = Field(
        None, description="ID of the inbox the thread belongs to."
    )
    status: Optional[ThreadStatus] = Field(
        None, description="The current status of the thread (OPEN or CLOSED)."
    )
    latestMessageReceivedTimestamp: Optional[str] = Field(
        None, description="Timestamp of the latest incoming message."
    )
...
class ListChannelAccountsResponse(BaseModel):
    ...
    total: Optional[int] = Field(
        None, description="Total number of channel accounts matching the query."
    )
    paging: Optional[Paging] = Field(
        None, description="Paging information for navigating results."
    )
    results: List[ChannelAccount] = Field(
        ..., description="List of channel account details."
    )
...
class ListMessagesResponse(BaseModel):
    ...
    results: List[MessageDetail] = Field(
        ..., description="List of message details (can be empty)."
    )
...
class OriginalMessageContentResponse(BaseModel):
    ...
    text: Optional[str] = Field(
        None, description="The full original plain text content."
    )
    richText: Optional[str] = Field(
        None, description="The full original rich text (HTML) content."
    )
...
class BatchReadActorsResponse(BaseModel):  # Renamed for clarity
    ...
    completedAt: Optional[str] = Field(
        None, description="Timestamp when the batch operation completed."
    )
    requestedAt: Optional[str] = Field(
        None, description="Timestamp when the batch operation was requested."
    )
    startedAt: Optional[str] = Field(
        None, description="Timestamp when the batch operation started."
    )
    links: Optional[Dict[str, str]] = Field(
        None, description="Links related to the batch operation."
    )
    results: List[Actor] = Field(
        ..., description="List of successfully retrieved actor details."
    )
    status: Optional[str] = Field(
        None, description="Status of the batch operation (e.g., 'PENDING', 'COMPLETE')."
    )
