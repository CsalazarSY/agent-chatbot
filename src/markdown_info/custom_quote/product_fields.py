...
from src.constants.hubspot.hubspot import HubSpotFieldType, HubSpotPropertyType
from src.constants.hubspot.property_names import HubSpotPropertyName
from src.constants.quick_quote.form_properties import ClingsFinishEnum, DecalsFloorOutdoorFinishEnum, DecalsFormatEnum, DecalsImageTransfersFinishEnum, DecalsWallWindowFinishEnum, ImageTransfersFinishEnum, IronOnsFormatEnum, IronOnsPageMultipleDesignsFinishEnum, IronOnsPageSingleDesignFinishEnum, IronOnsTransfersFinishEnum, LabelsFormatEnum, LabelsImageTransfersFinishEnum, LabelsKissCutFinishEnum, LabelsPageMultipleDesignsFinishEnum, LabelsPageSingleDesignFinishEnum, LabelsRollsFinishEnum, MagnetsFinishEnum, PouchesColor, PouchesLabelMaterialEnum, PouchesSizeEnum, ProductCategoryEnum, StickerDieCutFinishEnum, StickerFormatEnum, StickerKissCutFinishEnum, StickerPageMultipleDesignsFinishEnum, StickerPageSingleDesignFinishEnum, StickerRollsFinishEnum, StickerTransfersFinishEnum, TempTattoosFormatEnum, TempTattoosKissCutFinishEnum, TempTattoosPageMultipleDesignsFinishEnum, TempTattoosPageSingleDesignFinishEnum


CUSTOM_QUOTE_FORM_PRODUCT_FIELDS = f"""
