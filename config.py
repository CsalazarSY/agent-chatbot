...
# --- HubSpot Pipeline & Stage IDs (AI Chat Only) ---
HUBSPOT_PIPELINE_ID_AICHAT = get_required_env_variable("HUBSPOT_PIPELINE_ID_AICHAT")
HUBSPOT_PIPELINE_STAGE_ID_AICHAT_OPEN = get_required_env_variable("HUBSPOT_PIPELINE_STAGE_ID_AICHAT_OPEN")
HUBSPOT_PIPELINE_STAGE_ID_AICHAT_ASSISTANCE_ON_HOURS = get_required_env_variable("HUBSPOT_PIPELINE_STAGE_ID_AICHAT_ASSISTANCE_ON_HOURS")
HUBSPOT_PIPELINE_STAGE_ID_AICHAT_ASSISTANCE_OFF_HOURS = get_required_env_variable("HUBSPOT_PIPELINE_STAGE_ID_AICHAT_ASSISTANCE_OFF_HOURS")
HUBSPOT_PIPELINE_STAGE_ID_AICHAT_CLOSED = get_required_env_variable("HUBSPOT_PIPELINE_STAGE_ID_AICHAT_CLOSED")
